...
namespace Wheaterbit.Client
{
    internal sealed class WeatherbitHttpClient : IWeatherbitHttpClient
    {
        ...
        public Task<Result<ForecastWeatherDto>> GetSixteenDayForecast(double latitude, double longitude, string cityName, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        public Task<Result<CurrentWeatherDataDto>> GetCurrentWeather(double latitude, double longitude, string cityName, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        
        Task IWeatherbitHttpClient.GetCurrentWeather(double latitude, double longitude, string cityName, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
    }
