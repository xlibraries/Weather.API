...
namespace Weather.Infrastructure.UnitTests.Services
{
    public class WeatherServiceTests
    {
        ...
        {
            //Arrange
            var location = new LocationDto { Latitude = 15, Longitude = 25, CityName = "Mumford" };
            var failedMessage = "message";

            _weatherbiClientMock.Setup(x=>x.GetCurrentWeather(It.IsAny<double>(), It.IsAny<double>(), It.IsAny<string>(),  It.IsAny<CancellationToken>())).ReturnsAsync(Result.Fail(failedMessage));
            //Act
            ...
            _weatherbiClientMock.Verify(x => x.GetCurrentWeather(It.Is<double>(y=>y.Equals(location.Latitude)), It.Is<double>(y => y.Equals(location.Longitude)), It.Is<string>(y => y.Equals(location.CityName)),  It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task GetCurrentWeather_NullData()
        {
            ...
            _weatherbiClientMock.Setup(x => x.GetCurrentWeather(It.IsAny<double>(), It.IsAny<double>(),
                It.IsAny<string>(), It.IsAny<CancellationToken>())).ReturnsAsync(Result.Ok((CurrentWeatherDataDto)null));
            //Act
            var result = await _uut.GetCurrentWeather(location, CancellationToken.None);
            //Assert
            Assert.True(result.IsFailed);
            ...
            _weatherbiClientMock.Verify(x => x.GetCurrentWeather(It.Is<double>(y => y.Equals(location.Latitude)),
                It.Is<double>(y => y.Equals(location.Longitude)), It.Is<string>(y => y.Equals(location.CityName)),
        ...
        public async Task GetCurrentWeather_EmptyData()
        {
            ...
            _weatherbiClientMock.Setup(x => x.GetCurrentWeather(It.IsAny<double>(), It.IsAny<double>(), It.IsAny<string>(), It.IsAny<CancellationToken>())).ReturnsAsync(Result.Ok(new CurrentWeatherDataDto()));
            //Act
            var result = await _uut.GetCurrentWeather(location, CancellationToken.None);
            //Assert
            Assert.True(result.IsFailed);
        ...
        public async Task GetForecastWeather_Failed()
        {
            ...
            _weatherbiClientMock.Setup(x => x.GetSixteenDayForecast(It.IsAny<double>(), It.IsAny<double>(), It.IsAny<string>(), It.IsAny<CancellationToken>())).ReturnsAsync(Result.Fail(failedMessage));
            //Act
            ...
            Assert.Single(result.Errors);
            Assert.Equal(failedMessage, result.Errors.First().Message);
            _weatherbiClientMock.Verify(x => x.GetSixteenDayForecast(It.Is<double>(y => y.Equals(location.Latitude)), It.Is<double>(y => y.Equals(location.Longitude)), It.Is<string>(y => y.Equals(location.CityName)), It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task GetForecastWeather_NullData()
        {
            ...
            _weatherbiClientMock.Setup(x => x.GetSixteenDayForecast(It.IsAny<double>(), It.IsAny<double>(), It.IsAny<string>(),  It.IsAny<CancellationToken>())).ReturnsAsync(Result.Ok((Wheaterbit.Client.Dtos.ForecastWeatherDto)null));
            //Act
            var result = await _uut.GetForecastWeather(location, CancellationToken.None);
            //Assert
            Assert.True(result.IsFailed);
        ...
        public async Task GetForecastWeather_EmptyData()
        {
            ...
            _weatherbiClientMock.Setup(x => x.GetSixteenDayForecast(It.IsAny<double>(), It.IsAny<double>(), It.IsAny<string>(),  It.IsAny<CancellationToken>())).ReturnsAsync(Result.Ok(new Wheaterbit.Client.Dtos.ForecastWeatherDto()));
            //Act
            var result = await _uut.GetForecastWeather(location, CancellationToken.None);
            //Assert
            Assert.True(result.IsFailed);
        ...
        public async Task GetForecastWeather_Success()
        {
            ...
            _weatherbiClientMock.Setup(x => x.GetSixteenDayForecast(It.IsAny<double>(), It.IsAny<double>(), It.IsAny<string>(),  It.IsAny<CancellationToken>())).ReturnsAsync(Result.Ok(data));
