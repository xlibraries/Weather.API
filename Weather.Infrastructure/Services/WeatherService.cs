...
namespace Weather.Infrastructure.Services
{
    internal sealed class WeatherService : IWeatherService
    {
        ...
        {
            var currentWeatherResult = await _weatherbitHttpClient.GetCurrentWeather(locationDto.Latitude, locationDto.Longitude, locationDto.CityName, cancellationToken);
        ...
        {
            var forecastWeatherResult = await _weatherbitHttpClient.GetSixteenDayForecast(locationDto.Latitude, locationDto.Longitude, locationDto.CityName, cancellationToken);
